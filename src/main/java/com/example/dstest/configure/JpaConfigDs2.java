...
@EnableJpaRepositories(basePackages = "com.example.dstest.reposity.ds2", entityManagerFactoryRef = "entityManagerFactory2", transactionManagerRef = "transactionManager")
public class JpaConfigDs2 {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan("com.example.dstest.dao.ds2");// entity package
